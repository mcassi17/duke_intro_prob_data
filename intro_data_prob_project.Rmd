...
ggplot2 is the package that is used for producing plots and dplyr is used to filter, search, and manipulate dataframes. Both of these packages are loaded below.
